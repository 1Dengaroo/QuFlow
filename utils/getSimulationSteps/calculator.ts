import { AST } from "./getAstFromText";
import { ELStep, ELTask, Queue, WebApiTask } from "../types";
import { calculatorTraverse } from "./calculator.traverse";
import {
  EVENT_LOOP_WHEEL_STOPS_WITH_OVERLOAD,
  LAST_RENDER_INITIAL_TIME,
} from "../constants";
import { Node } from "acorn";
import { isSetTimeoutExpression } from "./utils";
import { isArrowFunctionExpression, isCallExpression } from "./guards";
