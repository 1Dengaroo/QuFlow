...
import { isFunctionDeclaration, isIdentifier, isLiteral } from "./guards";
import { ScopeManager } from "eslint-scope";
import { Queue, ELStep, WebApiTask } from "../types";

const isAstNode = (obj: unknown): boolean => {
  return (
    obj !== null &&
    typeof obj === "object" &&
    "type" in obj &&
    typeof (obj as Node).type === "string"
  );
};
...
export const calculatorTraverse = ({
  ast,
  logger,
  addToQueue,
  time,
